...
## 🌟 Projets Réalisés Mis en Avant

1. **Foody (France)** : 
   - Système de réception des appels téléphoniques par Intelligence Artificielle pour un restaurant en France.
   - Prise de commandes vocales, gestion des réservations de tables et réponses instantanées 24h/24 et 7j/7 sans appel manqué.
2. **Smoke House** :
   - Site web vitrine et plateforme moderne pour restaurant & grill de viandes fumées (menu digital interactif, réservations).
3. **Dar Baya** :
